...
const Header = ({ navigation }) => {
  ...
  // const onItemClick = (item) => {
   //const onItemClick = ({navigation}, item) => {
  /////const onItemClick = (item, props) => { //here
  const onItemClick = ({navigation}, item, props) => {
   ...
   /////// let categorynamestr = categoryname.toString() //here
   ...
   //////// navigation.navigate(categorynamestr); //here
        ...
        renderItem={({ item, index }) => {
          ...
          return (
            <TouchableOpacity
              ...
              //onPress={() => console.log(item.data.categoryName)}
